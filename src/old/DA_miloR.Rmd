...
```{r}
da_results_oligo <- readRDS(here("processed", project, "da_results_oligos.rds"))
da_results <- da_results[!(da_results$celltype %in% c("Oligo", "OPCs")), ]
da_results <- merge(da_results, da_results_oligo, all=TRUE)
```
