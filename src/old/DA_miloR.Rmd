...
knitr::opts_chunk$set(echo = TRUE, dev = c('pdf', 'png', 'tiff'), cache=TRUE)
```
...
```{r nhoodGraph, fig.width=15, fig.height=8}
...
plotDAbeeswarm(da_results, group.by = "clusters_named") +
  scale_fill_gradient2(high = scales::muted("red"), mid = "white", low = scales::muted("blue"))
```
