...
project <- "old"
source(here("src", project, "colours.R"))
...
da_results$celltype <- ifelse(da_results$clusters_named_fraction < 0.7, "Mixed", da_results$clusters_named)
```
...
# sort the order
da_results$clusters_named <- factor(da_results$clusters_named, 
                                    rev(c( "BAMs","Microglia","Gran & Mono","Lymphocytes","DCs","Astrocyte_1", "Astrocyte_2", "Astrocyte_3", "OligoAstro",  "OPCs","Oligo_1", "Oligo_2",  "Endothelial","fEndothelia","Mural_cells",  "Ependymocytes","OEG",  "ChP_epithelial", "iNeurons & NRPs", "mNeurons", "Mixed"
)))

da_results$celltype <- factor(da_results$celltype, 
                                    rev(c( "BAMs","Microglia","Gran & Mono","Lymphocytes","DCs","Astrocyte", "OligoAstro",  "OPCs","Oligo",  "Endothelial","Mural_cells",  "Ependymocytes","OEG",  "ChP_epithelial", "Neuron", "Mixed"
)))
