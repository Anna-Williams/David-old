...
```{r import}
if (!file.exists(here("processed", age, "sce_anno.RDS"))) {
...
We perform a DE between cluster 10 and the other clusters to pull out more interesting genes from this cluster
```{r}
# compute markers
