...
```{r gene-names}
if (!file.exists(here("processed", "old", "sce_preliminary.RDS"))) {
  ...
  sce <- readRDS(here( "processed", "old", "sce_preliminary.RDS"))
}
```
...
if (!file.exists(here( "processed", "old", "sce_preliminary.RDS"))) {
  ...
  saveRDS(sce, here( "processed", "old", "sce_preliminary.RDS"))
} else {
...
```{r}
if (!file.exists(here( "processed", "old", "sce_QC.RDS"))) {
  sce <- sce[, sce$discard == FALSE]
  saveRDS(sce, here( "processed", "old", "sce_QC.RDS"))
}
```
