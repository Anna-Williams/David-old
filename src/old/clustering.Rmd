...
```{r load-sce}
if(!file.exists(here("processed", age, "sce_clusters.RDS"))){
...
if(!file.exists(here("processed", age, "clusters_SNN_k5-k60.RDS"))){
  ...
  cluster_list <- 
    ...
    saveRDS(cluster_list, here("processed", age, "clusters_SNN_k5-k60.RDS"))
 ...
 saveRDS(sce, here("processed", age, "sce_clusters.RDS"))
  ...
  clusters_list <- readRDS(here("processed", age, "clusters_SNN_k5-k60"))
}
```
