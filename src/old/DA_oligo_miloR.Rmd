...
nh_graph_pl <- plotNhoodGraphDA(milo, da_results, layout="UMAP",alpha=0.1) + scale_fill_gradient2(high = muted("red"), mid = "white", low = muted("blue"))
nh_graph_tsne_pl <- plotNhoodGraphDA(milo, da_results, layout="TSNE",alpha=0.1) + scale_fill_gradient2(high = muted("red"), mid = "white", low = muted("blue"))
