...
In order to help with the identification of cluster 10 we pull out the
...
The top expressed genes are mostly ribosomal genes, there are often very
highly expressed genes, and not very informative.

We perform a DE between cluster 10 and the other clusters to pull out
more interesting genes from this cluster, this also yields ribosomal
...
levels(sce$celltype)<-c("Microglia-Macrophages", "Endothelial-Pericytes", "Astrocytes", "OPC", "Immune", "Astrocytes", "Monocytes", "Astrocytes", "Oligo", "NA", "ChP-epithelial", "Oligo", "Neuron?", "Oligo", "Neuron", "Microglia-Macrophages-BAM", "Oligo?", "Oligo", "OPC", "Endothelial-Pericytes", "Microglia-Macrophages", "Endothelial-Pericytes", "Astrocytes", "Microglia-Macrophages")
